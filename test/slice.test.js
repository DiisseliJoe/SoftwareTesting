...
describe("slice.test_1", () => {
    it("Negative start and end parameters for slicing array.", () =>{
        expect(slice([1,2,3,4], -2, -1)).to.equal([3])
    });
})
